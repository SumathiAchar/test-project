...
{
    /// <summary>
    /// Utility Class which contains all general method
    /// </summary>
    public static class Utilities
    {
        ...
        /// <returns></returns>
        public static List<ConditionRange> GetRanges(string code)
        {
        ...
        /// <param name="code">The code.</param>
        /// <returns></returns>
        public static IEnumerable<ConditionRange> GetRangesForPriPayerName(string code)
        {
            List<string> codeList = code.Split(';').ToList();
            List<ConditionRange> listOfString = new List<ConditionRange>();
        ...
        public static void ResetPaymentResult(PaymentResult paymentResult)
        {
            ...
            paymentResult.IsFormulaError = false;
        }
        ...
        public static void UpdatePaymentResult(PaymentResult paymentResult, long? serviceTypeId,
        ...
        /// <returns></returns>
        private static long GetListOfCodes(string codes)
        {
            long totalCount = 0;
        ...
        /// <param name="code">The code.</param>
        /// <returns></returns>
        private static long GetCodesFromRangeString(string code)
        {
        ...
        /// <returns></returns>
        public static bool IsTooManySelectionForClaimFields(string searchCriteria)
        {
        ...
        /// <returns></returns>
        public static string GetLocalTimeString(string currentDateTime, DateTime? dateTime = null)
        {
            if (dateTime == null)
            {
        ...
        /// <returns></returns>
        public static bool ValidateExpression(string expression, Dictionary<string, string> claimValuePair)
        {
            var variableFields =
            ...
            PaymentTypeBase paymentTypeBase,int occurence=0)
        {
            ...
            else paymentTypeBase.FormulaExpressionResult = threshold;
        ...
        /// <returns></returns>
        public static double? CalculateAllowedAmount(IEnumerable<PaymentResult> paymentResults)
        {
        ...
        public static List<string> SplitCsvRowToArray(string input)
        {
            string[] parts = null;
        ...
        /// <param name="input">csv string</param>
        /// <returns>a string array</returns>
        public static List<string> SplitCsvRowToArrayForAdjudication(string input)
        {
            string[] parts = null;
            if (!string.IsNullOrEmpty(input))
            {
        ...
        public static string Replace(string input, string replaceTo, string replaceWith)
        {
        ...
        /// <returns></returns>
        public static string GetSelectionCreteria(string selectionCriteria)
        {
