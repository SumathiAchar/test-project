...
<body>
    <script runat="server">
        ...
        {
            base.OnLoad(e);
            var instanceReportSource = new Telerik.Reporting.InstanceReportSource { ReportDocument = new ContractVarianceDetails(Model) };
    ...
    <form id="main" method="post" action="">
        <telerik:ReportViewer ID="primaryreportviewer" Width="100%" Height="570px" runat="server" EnableViewState="false">
